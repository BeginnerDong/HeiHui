const CONFIG = {
        ...
        development: {
                ...
                assetsPath: "http://test.solelyfinance.com/henghui", // 静态资源路径
                baseUrl: "http://test.solelyfinance.com/henghui/public/index.php/api/v1/",
        ...
        production: {
                loginTitleTxt: "欢迎使用选购商城", // 登录页标题
                copyrightTxt: "选购商城v1.0", // 版本信息
                assetsPath: "http://test.solelyfinance.com/henghui/wx/", // 静态资源路径
                baseUrl: "http://test.solelyfinance.com/henghui/public/index.php/api/v1/",
                tokenKey: "WECHAT_TRADE", // 登录标识
                testOpenId: "oEjRxwy7jL9PgG0kWeb4VcDTZEas", // 小程序测试openId
                forcedLogin: false, // touristMode游客模式下APP是否强制用户登录 场景：当用户进入登录页面后无法后退。
